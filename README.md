...
| dotnet-tracer-version          | The version of Datadog .NET tracer to use.                                                                                                                                                                                                                                                         | false    | 3.54.0        |
| java-tracer-version            | The version of Datadog Java tracer to use.                                                                                                                                                                                                                                                         | false    | 1.66.0        |
| js-tracer-version              | The version of Datadog JS tracer to use.                                                                                                                                                                                                                                                           | false    | 6.16.0        |
| python-tracer-version          | The version of Datadog Python tracer to use.                                                                                                                                                                                                                                                       | false    | 4.15.2        |
| python-coverage-version        | The version of the Python `coverage` package to use.                                                                                                                                                                                                                                               | false    | 7.16.1        |
| ruby-tracer-version            | The version of datadog-ci Ruby gem to use.                                                                                                                                                                                                                                                         | false    | 1.39.0        |
| go-tracer-version              | The version of Orchestrion to use.                                                                                                                                                                                                                                                                 | false    | v1.13.1       |
